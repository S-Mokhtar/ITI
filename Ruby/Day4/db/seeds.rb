...
r1 = Role.create({ name: 'Regular', description: 'Normal User' })
r2 = Role.create({ name: 'SuperAdmin', description: 'Controls everything' })
r3 = Role.create({ name: 'Admin', description: 'Can perform CRUD operations on items' })
